    ...
    <>
      <div className="grid grid-cols-5 gap-4">
        <div className="col-span-2">
          <div>
            <div className="text-right">
              <h1 className="m-2">2019-2022</h1>
              <h3 className="font-bold m-2">INTERNSHIP</h3>
              <h3 className="m-2 text-xs">Department of Social Welfare and Development</h3>
              <p className="m-2">
        ...
        <div className="justify-center text-center">
          <div class="border-primary last:font-semibold text-xl w-7 h-7 rounded-full inline-flex items-center justify-center select-none z-10 bg-black mt-2.5">
            <div class="text-white text-center w-2 h-2 rounded-full bg-white"></div>
          </div>
