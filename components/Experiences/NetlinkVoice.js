    ...
    <>
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="justify-center text-center">
          {/* Black Circle Itself */}
          <div className="border-primary last:font-semibold text-xl w-7 h-7 rounded-full inline-flex items-center justify-center select-none z-10 bg-black mt-2.5">
            {/* Dot at the middle of black circle */}
            <div className="text-white text-center w-2 h-2 rounded-full bg-white"></div>
          </div>
          {/* The black line */}
